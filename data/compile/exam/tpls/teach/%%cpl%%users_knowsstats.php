...
<?php } ?>
				...
				<div class="box itembox" style="padding-top:10px;margin-bottom:0px;">
					<h4 class="title" style="padding:10px;">
						知识点正确率分析
						<a class="pull-right btn btn-primary" href="index.php?exam-teach-users-stats&basicid=<?php echo $this->tpl_var['basicid']; ?><?php echo $this->tpl_var['u']; ?>">试题正确率分析</a>
					</h4>
 ...
 $sid++; ?>
					        <tr>
								<td>
									<?php echo $stat['knowsid']; ?>
								</td>
								<td>
									<?php echo html_entity_decode($this->ev->stripSlashes($stat['knows'])); ?>
								</td>
								<td>
